  ...
  return <div className="app-shell">
    ...
    <main>
      {page === 'dashboard' && <>
        ...
        {(notice || actionError) && <div className={actionError ? 'toast error' : 'toast'} role="status" aria-live={actionError ? 'assertive' : 'polite'}>{actionError || notice}<button type="button" onClick={() => { setNotice(''); setActionError('') }} aria-label="Dismiss message">×</button></div>}
