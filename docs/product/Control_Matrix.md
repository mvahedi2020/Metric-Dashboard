...
| Freshness | Observation-age label | Keeps the Sep 8, 2026 sample observation date visible with an age calculated from the viewing clock | This is fixture freshness, not a live-data health signal |
