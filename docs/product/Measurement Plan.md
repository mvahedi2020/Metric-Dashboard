...
| Scoped handoff | Completes scope selection → interpretation → copy or export while the note and handoff retain the selected segment and period. | 5 participants | Directional diagnostic; completion time is reported separately. | Can carry context through the review flow. | Do not score a note as scoped if the participant cannot identify its label. |
